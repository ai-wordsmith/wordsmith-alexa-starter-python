"""
This file is based on the alexa-skills-kit-color-expert-python that is available
as a Python blueprint for Amazon Lambda. This contains much of the functionality
that you might need to build a production-ready Alexa skill.
...
def get_welcome_response():
    ...
    session_attributes = {}
    card_title = "<YOUR WELCOME CARD TITLE HERE>"
    speech_output = "<YOUR WELCOME MESSAGE HERE>"
    # If the user either does not reply to the welcome message or says something
    # that is not understood, they will be prompted again with this text.
    reprompt_text = "<YOUR REPROMPT TEXT HERE>"
...
def handle_session_end_request():
    card_title = "<YOUR SESSION END CARD TITLE HERE>"
    speech_output = "<YOUR SESSION END MESSAGE HERE"
